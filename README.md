...
```
.
├── template.ipynb         # Main analysis notebook (all steps)
├── index.html             # HTML web version of the project report
├── RAW_recipes.csv        # Raw recipe data (not included in repo)
├── interactions.csv       # Raw user interaction data (not included in repo)
└── README.md              # This file
```

> **Note:** The raw data files (`RAW_recipes.csv` and `interactions.csv`) are not included in this repository. They can be obtained from the [Food.com Recipes and Interactions dataset on Kaggle](https://www.kaggle.com/datasets/shuyangli94/food-com-recipes-and-user-interactions).
...
2. Download the dataset files (`RAW_recipes.csv` and `interactions.csv`) and place them in the root directory.
...
This project was completed as the DSC 80 Final Project. Data sourced from Food.com via the [Kaggle Food.com Recipes and Interactions dataset](https://www.kaggle.com/datasets/shuyangli94/food-com-recipes-and-user-interactions).
